<?php
	...
	if ( !isset( $sender ) ) { header('Location: http://'. $_SESSION[ "HTTP_HOST" ]); }
	
	//Server path
	$server_path = "/home/blogycoo/public_html/";

	$target_dir = $server_path."Library/Authors/$sender/Album/";
	...
	// if everything is ok, try to upload file
		...
		if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
			...
			if ( !isset($_POST["isClub"]) ) { echo "<script>window.location='../album.php'</script>"; }

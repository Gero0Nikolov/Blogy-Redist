...
<body style="overflow-x: hidden;">
	...
	?>
				<div class="club-invitation-dialog mt-60">
					<h1>
					...
					<button class='agree-button' onclick="acceptClubInvitation(0);">Join!</button>
					<button class='decline-button' onclick='declineClubInvitation(0);'>Decline</button>
				</div>
	<?php
			}

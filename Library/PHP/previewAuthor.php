<?php
	...
	if($detect->isMobile() && !$detect->isTablet()) {
		$location = "http://".$_SERVER[HTTP_HOST]."/Library/PHP/Mobile/previewAuthor.php?$getID";
...
<html>
	...
	<body onload='loadStories(-1, \"4\", 0, \"$getID\");' onscroll='checkPos()'>
		<div id='profile-container' style='background-image: url(\"../images/backgrounds/$random_background.jpg\");'>
		...
		<div id='lock-story-container' onclick='hideStory();'>
			<div class='profile-picture' style='background-image: url($profilePic); background-size: cover; background-position: 50%;'>
			</div>
		</div>
		<div id='body'>

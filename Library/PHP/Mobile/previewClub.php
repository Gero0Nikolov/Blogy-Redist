<?php 
	...
	if ($catchOwnerId != "" && $catchClubId != "") {
		...
		//Fix logo
		if ( strpos($getClubLogo, "./") && !strpos($getClubLogo, "./../") ) {
		...
		<div id="club-header" class="<?php echo $getClubColor; ?>">
			...
			?>
					...
					<div class="club-invitation-dialog">
						...
						<button class='just-button' onclick="sendJoinClubRequest('location.reload', <?php echo $isMobile; ?>);">Join !</button>
					</div>
			<?php
			...
			?>
					...
					<div class="club-invitation-dialog">
						...
						<button class='decline-button' onclick="cancelJoinClubRequest('location.reload', <?php echo $isMobile; ?>);">Cancel</button>
					</div>
			<?php
						endif;
			...
			?>
					...
					<div id='club-header-menu' class='full-width-container'>
						<div id='club-header-settings-mainmenu' class='menu-container right-aligned white-menu right-margin-25'>
							<button class='club-header-button' onclick="sendJoinClubRequest('location.reload', <?php echo $isMobile; ?>);"><span>&#xf0a5;</span>Join us!</button>
						</div>
					</div>
					...
					<div id='club-header-menu' class='full-width-container'>
						<div id='club-header-settings-mainmenu' class='menu-container right-aligned white-menu right-margin-25'>
							<button class='club-header-button' onclick="cancelJoinClubRequest('location.reload', <?php echo $isMobile; ?>);"><span>&#xf00d;</span>Cancel</button>
						</div>
					</div>

<?php
	...
	fwrite($commitConfig, "http://www.".$_SERVER["HTTP_HOST"]."/Library/Authors/$sender/Album/".$newPicture.PHP_EOL);
	...
	$newPic = "http://www.".$_SERVER["HTTP_HOST"]."/Library/Authors/$sender/Album/".$newPicture;
	
	$_SESSION["senderImg"] = $newPic;
	echo "
		<script>
